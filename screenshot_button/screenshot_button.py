...
class ScreenshotButton(tk.Button):
    ...
    def capture_screenshot(self):
        ...
        # Schedule the screenshot after a delay (1000 milliseconds = 1 second)
        self.master.after(1000, self.take_screenshot_with_delay)

    def take_screenshot_with_delay(self):
    ...
    def add_caption(self, image, caption):
        ...
        # Assuming you want to leave a margin of 10 pixels
        margin = 10

        # Calculate the position to anchor the caption in the bottom right corner
        text_position = (image.width - text_width - margin, image.height - text_height - margin)
        ...
        draw.text(text_position, caption, font=font, fill=(0, 0, 0))
    ...
    def quit_application(self):
        ...
        if messagebox.askyesno("Save Combined Image", "Do you want to save the combined image before quitting?"):
            ...
            # Open the combined image with the default image viewer
            subprocess.run(["open", combined_filename])  # Adjust for Windows or Linux if needed
